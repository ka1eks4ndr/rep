...
public:
    ...
    SingleLinkedList(const SingleLinkedList& other) {
            ...
            auto it_temp=tmp.before_begin();
            while (it_other!=other.end()) {
               
                it_temp=tmp.InsertAfter(it_temp,*it_other);
                ++it_other;
            }
            swap(tmp);
    }
    ...
    Iterator EraseAfter(ConstIterator pos) noexcept {
        auto prev = pos.node_->next_node;
        auto forward = prev->next_node;
        delete pos.node_->next_node;
        pos.node_->next_node=forward;
        --size_;
        return Iterator(pos.node_->next_node);
    }

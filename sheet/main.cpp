...
void MyTest () {
    auto sheet = CreateSheet();
    sheet->SetCell("B18"_pos, "12");
    sheet->SetCell("E18"_pos, "15");
    sheet->SetCell("E8"_pos, "=B18+E18");
    sheet->SetCell("E10"_pos, "4");
    sheet->SetCell("F11"_pos, "=E10");
    sheet->SetCell("H9"_pos, "=F11");
    sheet->SetCell("K5"_pos, "=H9+G3+E8");
    sheet->SetCell("G3"_pos, "24");
    // std::cout << sheet->GetCell("K5"_pos)->GetValue() << std::endl;
    ASSERT_EQUAL(std::get<double>(sheet->GetCell("K5"_pos)->GetValue()), 55);
    sheet->SetCell("E18"_pos, "4");
    // std::cout << sheet->GetCell("K5"_pos)->GetValue() << std::endl;
    ASSERT_EQUAL(std::get<double>(sheet->GetCell("K5"_pos)->GetValue()), 44);
    sheet->SetCell("E8"_pos, "=B18+E18+B4");
    // std::cout << sheet->GetCell("K5"_pos)->GetValue() << std::endl;
    ASSERT_EQUAL(std::get<double>(sheet->GetCell("K5"_pos)->GetValue()), 44);
    sheet->SetCell("B4"_pos, "24");
    ASSERT_EQUAL(std::get<double>(sheet->GetCell("K5"_pos)->GetValue()), 68);
    sheet->SetCell("E8"_pos, "1");
    ASSERT_EQUAL(std::get<double>(sheet->GetCell("K5"_pos)->GetValue()), 29);

    auto sheet2 = CreateSheet();
    sheet2->SetCell("C2"_pos, "12");
    sheet2->SetCell("B4"_pos, "15");
    sheet2->SetCell("B2"_pos, "=C2-B4");
    ASSERT_EQUAL(std::get<double>(sheet2->GetCell("B2"_pos)->GetValue()), -3);
    sheet2->ClearCell("C2"_pos);
    ASSERT_EQUAL(std::get<double>(sheet2->GetCell("B2"_pos)->GetValue()), -15);
